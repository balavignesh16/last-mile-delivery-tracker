...
func (f *fakeRepo) Transition(ctx context.Context, orderID, actorID string, role, actorRole users.Role, newStatus Status, metadata json.RawMessage) (Event, error) {
	return f.TransitionTx(ctx, nil, orderID, actorID, role, actorRole, newStatus, metadata)
}
...
func (f *fakeRepo) TransitionTx(_ context.Context, _ pgx.Tx, orderID, actorID string, role, actorRole users.Role, newStatus Status, metadata json.RawMessage) (Event, error) {
